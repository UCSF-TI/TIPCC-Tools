...
class R(Package):
    ...
    url = "http://cloud.r-project.org/src/base/R-3/R-3.3.2.tar.gz"
    ...
    version('3.2.4', '5953104583ed93dc2085a6c80e884e4a')
    ...
    version('3.1.1', '2598f5bbbedb00e463e0c1385e6fe999')
    version('3.1.0', 'a1ee52446bee81820409661e6d114ab1')
    version('3.0.3', 'f9025976863847f2d0502254d0f0dbf2')
    version('3.0.2', 'f9a8374736e7650e4848f33e2e3bbee3')
    version('3.0.1', '36d51544b007fff26c7fbf36b02ea5ad')
    version('3.0.0', '5fb80535b0e144a978f67aa2158015de')
    
    variant('profmem', default=True,
            description='attempt to compile support for Rprofmem() and tracemem()')
    ...
    def install(self, spec, prefix):
        ...
        if '+profmem' in spec:
            configure_args.extend(['--enable-memory-profiling'])
